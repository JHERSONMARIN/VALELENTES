...
function renderTicketModal({
  ...
  document.getElementById('rec-method').innerText = paymentMethod === 'Cortesia' ? '🎁 Cortesía / Atención Especial' : paymentMethod;
  ...
  try {
    ...
    if (select) {
      ...
      if (CATEGORIES.length === 0) {
        select.innerHTML = '<option value="Monturas / Armazones">Monturas / Armazones</option>';
      } else {
...
const PRODUCT_PRESETS = [
  { code: 'OPT-MON-001', name: 'Montura Acetato Modena Unisex Negro', category: 'Monturas / Armazones', purchase_price: 45.00, price: 120.00, stock: 15, min_stock: 3 },
  { code: 'OPT-MON-002', name: 'Montura Metálica Aviador Titanio Dorado', category: 'Monturas / Armazones', purchase_price: 60.00, price: 160.00, stock: 12, min_stock: 3 },
  { code: 'OPT-MON-003', name: 'Montura Flexible Niños TR90 Anticaídas Azul', category: 'Monturas / Armazones', purchase_price: 35.00, price: 95.00, stock: 18, min_stock: 4 },
  { code: 'OPT-MON-004', name: 'Montura Carey Retro Vintage Dama', category: 'Monturas / Armazones', purchase_price: 50.00, price: 135.00, stock: 10, min_stock: 2 },
  { code: 'OPT-MON-005', name: 'Montura Semi al Aire (Ranurada) Ejecutiva', category: 'Monturas / Armazones', purchase_price: 55.00, price: 145.00, stock: 8, min_stock: 2 },
  { code: 'OPT-LUN-001', name: 'Lunas Monofocales CR-39 Blancas (Par)', category: 'Lunas Oftálmicas', purchase_price: 20.00, price: 50.00, stock: 30, min_stock: 6 },
  { code: 'OPT-LUN-002', name: 'Lunas Antirréflex Verde EMI UV400 (Par)', category: 'Lunas Oftálmicas', purchase_price: 35.00, price: 85.00, stock: 25, min_stock: 5 },
  { code: 'OPT-LUN-003', name: 'Lunas Blue Defense Filtro Luz Azul 1.56 (Par)', category: 'Lunas Oftálmicas', purchase_price: 50.00, price: 130.00, stock: 20, min_stock: 5 },
  { code: 'OPT-LUN-004', name: 'Lunas Fotocromáticas Gris Antirréflex (Par)', category: 'Lunas Oftálmicas', purchase_price: 75.00, price: 180.00, stock: 15, min_stock: 4 },
  { code: 'OPT-LUN-005', name: 'Lunas Policarbonato Resistente a Impactos (Par)', category: 'Lunas Oftálmicas', purchase_price: 45.00, price: 110.00, stock: 20, min_stock: 4 },
  { code: 'OPT-LUN-006', name: 'Lunas Progresivas Digitales FreeForm (Par)', category: 'Lunas Oftálmicas', purchase_price: 130.00, price: 320.00, stock: 10, min_stock: 2 },
  { code: 'OPT-SOL-001', name: 'Lentes de Sol Polarizados UV400 Dark Night', category: 'Lentes de Sol', purchase_price: 40.00, price: 99.00, stock: 15, min_stock: 3 },
  { code: 'OPT-SOL-002', name: 'Lentes de Sol Aviador Clásico Espejado Plata', category: 'Lentes de Sol', purchase_price: 45.00, price: 110.00, stock: 12, min_stock: 3 },
  { code: 'OPT-SOL-003', name: 'Lentes de Sol Cat Eye Dama Protección Total', category: 'Lentes de Sol', purchase_price: 48.00, price: 125.00, stock: 10, min_stock: 2 },
  { code: 'OPT-SOL-004', name: 'Lentes de Sol Deportivos Envolventes Ciclismo', category: 'Lentes de Sol', purchase_price: 52.00, price: 135.00, stock: 10, min_stock: 2 },
  { code: 'OPT-CON-001', name: 'Lentes de Contacto Blandos Mensuales (Caja 6un)', category: 'Lentes de Contacto', purchase_price: 70.00, price: 140.00, stock: 12, min_stock: 3 },
  { code: 'OPT-CON-002', name: 'Lentes de Contacto Cosméticos Color FreshLook', category: 'Lentes de Contacto', purchase_price: 45.00, price: 95.00, stock: 15, min_stock: 3 },
  { code: 'OPT-CON-003', name: 'Lentes de Contacto Diarios Desechables (30un)', category: 'Lentes de Contacto', purchase_price: 85.00, price: 170.00, stock: 8, min_stock: 2 },
  { code: 'OPT-SOL-010', name: 'Solución Multipropósito Solent 360ml con Estuche', category: 'Soluciones y Gotas', purchase_price: 22.00, price: 38.00, stock: 24, min_stock: 5 },
  { code: 'OPT-SOL-011', name: 'Solución de Viaje para Lentes de Contacto 120ml', category: 'Soluciones y Gotas', purchase_price: 14.00, price: 25.00, stock: 20, min_stock: 4 },
  { code: 'OPT-SOL-012', name: 'Gotas Humectantes / Lágrimas Artificiales 15ml', category: 'Soluciones y Gotas', purchase_price: 16.00, price: 29.00, stock: 25, min_stock: 5 },
  { code: 'OPT-ACC-001', name: 'Estuche Rígido para Lentes con Cierre Magnético', category: 'Accesorios y Estuches', purchase_price: 6.00, price: 15.00, stock: 40, min_stock: 8 },
  { code: 'OPT-ACC-002', name: 'Paño de Microfibra Antiestático Premium', category: 'Accesorios y Estuches', purchase_price: 2.00, price: 6.00, stock: 50, min_stock: 10 },
  { code: 'OPT-ACC-003', name: 'Spray Limpiador Antiempañante Óptico 60ml', category: 'Accesorios y Estuches', purchase_price: 7.00, price: 18.00, stock: 30, min_stock: 6 },
  { code: 'OPT-ACC-004', name: 'Cordón Sujetador Deportivo de Silicona', category: 'Accesorios y Estuches', purchase_price: 3.50, price: 9.00, stock: 35, min_stock: 6 },
  { code: 'OPT-ACC-005', name: 'Kit Destornillador Óptico con Tornillos de Repuesto', category: 'Accesorios y Estuches', purchase_price: 8.00, price: 20.00, stock: 20, min_stock: 4 },
  { code: 'OPT-SRV-001', name: 'Examen y Medida de la Vista Completo (Optometría)', category: 'Servicios de Optometría', purchase_price: 0.00, price: 30.00, stock: 999, min_stock: 5 },
  { code: 'OPT-SRV-002', name: 'Mantenimiento, Calibración y Cambio de Plaquetas', category: 'Servicios de Optometría', purchase_price: 2.00, price: 15.00, stock: 999, min_stock: 5 }
];
...
// ==========================================
// CARGA MASIVA DE CATÁLOGO BASE DE ÓPTICA (EN 1 CLIC)
// ==========================================
async function confirmBulkCatalogLoad() {
  ...
  const msg = `📦 ¿Deseas cargar el Catálogo Base con ${PRODUCT_PRESETS.length} productos y servicios de óptica con stock inicial?\n\n- Categorías: Monturas, Lunas Oftálmicas, Lentes de Sol, Contacto, Soluciones, Accesorios y Servicios.\n- Productos ya registrados en tu inventario (${existingCount}) no serán duplicados.\n- Podrás editar precios y stock en cualquier momento.`;
