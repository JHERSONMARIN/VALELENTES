...
const pool = new Pool({
  ...
  database: process.env.POSTGRES_DB || 'valelentes_db'
});
  ...
  try {
    ...
    await pool.query(`
      CREATE TABLE IF NOT EXISTS products (
        ...
        category VARCHAR(100) NOT NULL DEFAULT 'Monturas / Armazones',
    ...
    await pool.query(`
      CREATE TABLE IF NOT EXISTS company_settings (
        ...
        name VARCHAR(255) NOT NULL DEFAULT 'ÓPTICA VALE-LENTES by VALETEC',
        ...
        ticket_footer VARCHAR(255) NOT NULL DEFAULT '¡Gracias por su preferencia! Su salud visual en las mejores manos.',
  ...
  try {
    ...
    if (parseInt(resCust.rows[0].count) === 0) {
      ...
      await pool.query(`
        ...
        ('10458923011', 'Comercial Don José S.A.C.', '912345678', 'Jr. Comercio 456', 0);
      `);
    }
